...
module "bastion" {
  ...
  minio_ca_cert_pem                = module.minio.minio_ca_cert_pem
  ...
  minio_cli_private_key_pem        = module.minio.minio_cli_private_key_pem
  ...
  minio_cli_cert_pem               = module.minio.minio_cli_cert_pem
  consul_master_token              = module.consul_cluster.consul_master_token
  minio_server                     = "dc1-server-minio.msk.local:9000"
}
